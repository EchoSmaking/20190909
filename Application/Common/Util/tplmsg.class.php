...
class tplmsg{
	...
	*/
	...
	// 发送订单支付通知
	public function pay_notice($openid,$order_sn,$total,$pwayway){
		if(empty($GLOBALS['_CFG']['tplmsg']['OPENTM205297594']['id']) || $GLOBALS['_CFG']['tplmsg']['OPENTM205297594']['status'] != 1){
			return false;
		}
		
		switch($pwayway){
			case 'points':$pwayway = $GLOBALS['_CFG']['site']['points_name'];break;
			case 'money':$pwayway = '余额';break;
			case 'wxpay':$pwayway = '微信支付';break;
			case 'alipay':$pwayway = '支付宝';break;
		}
