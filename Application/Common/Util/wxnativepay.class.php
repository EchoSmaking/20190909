...
class wxnativepay {
 public function _construct($param = null){
	...
	{
		//if($input->value['trade_type'] == "NATIVE")
		//{
		//	$result = $this->code_url;
		//	return $result;
		//}
		//print_r($this->code_url);
	...
	* 获得native参数
	*/
	public function get_native_parameters(){
		$time = NOW_TIME;
		$data = array(
	...
	*/
	public function unifiedOrder(){
		$url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
                if(empty($this -> values['trade_type']))$this -> values['trade_type']='JSAPI';//默认是公众号支付
		$param = array(
			'appid' 			=> $this -> values['appid'],
			...
			'trade_type' 		=> $this -> values['trade_type'],
	...
	*/
		...
		//获取查询结果
			...
			return false;
                    ...
                    $this -> order_state = $orderQueryResult["trade_state"];
			return $orderQueryResult["trade_state"];
    		     }	
        }
